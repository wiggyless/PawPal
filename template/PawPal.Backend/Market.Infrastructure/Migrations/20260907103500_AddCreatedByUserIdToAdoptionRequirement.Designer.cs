...
namespace PawPal.Infrastructure.Migrations
{
    ...
    [Migration("20260907103500_AddCreatedByUserIdToAdoptionRequirement")]
    partial class AddCreatedByUserIdToAdoptionRequirement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PawPal.Domain.Entities.Adoptions.AdoptionRequirementEntity", b =>
                {
                    ...
                    b.ToTable("AdoptionRequirements", (string)null);
                });
            ...
            modelBuilder.Entity("PawPal.Domain.Entities.Adoptions.AdoptionStoryEntity", b =>
                {
                    ...
                    b.ToTable("AdoptionStories", (string)null);
                });
            ...
            modelBuilder.Entity("PawPal.Domain.Entities.Animal_Info.AnimalHealthHistoryEntity", b =>
                {
                    ...
                    b.ToTable("AnimalHealthHistories", (string)null);
                });
            ...
            modelBuilder.Entity("PawPal.Domain.Entities.Animal_Info.ManyToMany.AllergiesAnimalHealthHistory", b =>
                {
                    ...
                    b.ToTable("AnimalsAllergies", (string)null);
                });
            ...
            modelBuilder.Entity("PawPal.Domain.Entities.Animal_Info.ManyToMany.AnimalCharacteristics", b =>
                {
                    ...
                    b.ToTable("AnimalCharacteristics", (string)null);
                });
            ...
            modelBuilder.Entity("PawPal.Domain.Entities.Animal_Info.ManyToMany.DisabilitiesAnimalHealthHistory", b =>
                {
                    ...
                    b.ToTable("AnimalsDisabilities", (string)null);
                });
            ...
            modelBuilder.Entity("PawPal.Domain.Entities.Identity.UserDisabledHistoryEntity", b =>
                {
                    ...
                    b.ToTable("UserDisabledHistory", (string)null);
                });
            ...
            modelBuilder.Entity("PawPal.Domain.Entities.Identity.UserImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PawPal.Domain.Entities.Messaging.UserToUserMessages", b =>
                {
                    ...
                    b.ToTable("UserToUserMessages", (string)null);
                });
            ...
            modelBuilder.Entity("PawPal.Domain.Entities.Moderation.ReportProblemEntity", b =>
                {
                    ...
                    b.ToTable("ReportProblems", (string)null);
                });
            ...
            modelBuilder.Entity("PawPal.Domain.Entities.Moderation.ReportedCommentsEntity", b =>
                {
                    ...
                    b.ToTable("ReportedComments", (string)null);
                });
            ...
            modelBuilder.Entity("PawPal.Domain.Entities.Posts.LikedUserPosts", b =>
                {
                    ...
                    b.ToTable("LikedUserPosts", (string)null);
                });

            modelBuilder.Entity("PawPal.Domain.Entities.Posts.PostImagesEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConversationEntity", b =>
                {
                    b.HasOne("PawPal.Domain.Entities.Identity.UserEntity", "User1")
                        .WithMany()
                        .HasForeignKey("User1Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PawPal.Domain.Entities.Identity.UserEntity", "User2")
                        .WithMany()
            ...
            modelBuilder.Entity("MessageEntity", b =>
                {
                    ...
                    b.HasOne("PawPal.Domain.Entities.Identity.UserEntity", "Sender")
                        .WithMany()
