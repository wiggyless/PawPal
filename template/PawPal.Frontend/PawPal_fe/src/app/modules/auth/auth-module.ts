...
import {
  MatInput, MatFormField, MatLabel, MatHint, MatSuffix, MatError
...
import { PasswordRecoveryDialog } from './login/password-recovery-dialog/password-recovery-dialog/password-recovery-dialog';
